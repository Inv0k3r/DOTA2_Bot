...
OPENDOTA_PARSE_RETRY_INTERVAL = max(
    30.0, float(os.getenv("OPENDOTA_PARSE_RETRY_INTERVAL", "120"))
)
...
PREDICTION_TRANSFER_MAX = max(
    1, int(os.getenv("PREDICTION_TRANSFER_MAX", "100000"))
)
